                ...
                <ul ref={slider}>
                    <li>
                        <div className="slide">
                            ...
                            <p>Choosing to pursue my degree at IIITK was one of the best decisions I've ever made. The supportive community, state of the art facilities and commitment to academic excellence have truly exceeded my expectations.</p>
                        </div>
                    </li>
                    <li>
                        <div className="slide">
