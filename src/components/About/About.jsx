...
import "./About.css"
import about_img from '../../assets/longview111.jpg'
    ...
    return (
        <div className='about'>
            ...
            <div className='about_right'>
                ...
                <p>With a focus on innovation, hands on learning, and personalized mentorship, our programs prepare aspiring educators to make a meaningful impact in classroms, schools, and commmunities</p>
